...
<div class="card-body p-5 mt-5">
    <form method="post"  action="{{ route("addRequest" ,"test") }}" autocomplete="off">
        @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>name your problim:  <span class="text-danger">*</span></label>
                        <input  type="hidden" name="service_id" value="{{ $service->id }}"  class="form-control">
                        <input  type="hidden" name="user_id" value="{{ Auth::user()->id }}"  class="form-control">
                        <input  type="hidden" name="category_id" value="{{$service->category->id}}"  class="form-control">
