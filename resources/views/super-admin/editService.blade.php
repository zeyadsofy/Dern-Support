@include("layout.adminLayout")
        ...
        <div class="card-body px-0 pt-0 pb-2">
            <form method="post"  action="{{ route("editService1") }}" autocomplete="off">
                @method('PUT')
                @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input  type="text" name="desc" value="{{ $service->desc }}" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="gender">Category : <span class="text-danger">*</span></label><br>
                                <select class="custom-select form-select mr-sm-2" name="category_id">
